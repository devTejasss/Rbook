...
import { AiOutlineShopping, AiOutlineShop, AiOutlineUser } from 'react-icons/ai'
...
const Navbar = () => {
  ...
  return (
    ...
    { user && <button type="button" className="cart-icon" onClick="">
        <AiOutlineShop />
      </button>}
      ...
      { !user && <button type="button"  onClick={login} className="btnn">
        Login/Signup
      </button>}

      {user && <button className="btnn" >{user.email}</button>}

      { user && <button type="button"  onClick={logout} className="btnn">
        Logout
      </button>}
